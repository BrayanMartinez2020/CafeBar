                    ...
                    <div class="card-body">
                        <form action="ProductoCTO?menu=Producto" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <label style="color: white; font-size: 20px">Nombre producto</label>
